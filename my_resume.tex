...
\firstname{汪}
\familyname{广鑫}
\title{WANG Guangxin}               % optional, remove the line if not wanted
% \address{杭州}{}    % optional, remove the line if not wanted
\address{1997/01/05}{}    % optional, remove the line if not wanted
\mobile{15776555129}                    % optional, remove the line if not wanted
%\fax{fax (optional)}                          % optional, remove the line if not wanted
\email{w-gx@qq.com}                     % optional, remove the line if not wanted
\homepage{Blog: https://cuffs.cf} % optional, remove the line if not wanted
\social[github]{GitHub: https://github.com/WANG-Guangxin}
\extrainfo{%
